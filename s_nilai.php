<body>
	...
	<center><table width="800" border="0">
		<tr><th>Id Nilai</th><th>NIS</th><th>Tanggal Ujian</th><th>Nilai</th></tr>
		<?php
		if(isset($_POST[submit])){
			$query=mysql_query("SELECT * FROM tnilai WHERE tanggal_ujian='$_POST[tanggal]' AND IdMatPel='$_POST[matpel]' AND nis='$_POST[nis]'");
